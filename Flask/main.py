...
table_names = ["SPABBATHI.IUCR", "SPABBATHI.FBI", "KONDURUS.LOCATION", "SPABBATHI.DISTRICT", "SPABBATHI.SEASON", "KONDURUS.DIVISION", "KONDURUS.GEO_COORDINATES", "KONDURUS.POLICE_SENTIMENT_SCORE", '"YARAVA.VENKATASU".CRIME_INCIDENT']
